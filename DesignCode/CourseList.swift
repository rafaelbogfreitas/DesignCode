...
//  DesignCode
//
//  Created by Rafael Freitas on 15/02/21.
//
    ...
    var body: some View {
        ...
        ZStack(alignment: .top) {
            VStack(alignment: .leading, spacing: 30.0) {
                Text("Take your SwiftUI app to the App Store with advanced techniques like API data, packges and CMS")
            ...
            .shadow(color: Color(#colorLiteral(red: 0.5568627715, green: 0.3529411852, blue: 0.9686274529, alpha: 1)).opacity(0.4), radius: 20, x: 0, y: 20)
            .onTapGesture {
                self.show.toggle()
            }
        }
